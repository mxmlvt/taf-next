...
const BLOG_POSTS_EN = [
  ...
  { slug: 'zippers-in-the-furniture-industry', title: 'Zippers in the Furniture Industry', excerpt: 'In the furniture industry, zippers play a key role in the functionality and aesthetics of upholstery and covers, allowing for easy removal for cleaning.', date: '2025-07-02', img: 'https://trimsandfasteners.com/wp-content/uploads/2025/07/zamek5cc.png' },
